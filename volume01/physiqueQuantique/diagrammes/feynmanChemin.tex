...
%Création des axes xy
   ...
   \draw[-latex, very thick] (0,0) -- (0,5) node[left] {temps};
% Définition des noeuds
   \coordinate (e1) at (1.5,1);   \coordinate (e2) at (4.2,1);   \coordinate (e5) at (2,2.4);

   \coordinate (e3) at (1,4);   \coordinate (e4) at (4.4,4);   \coordinate (e6) at (3.4,2.6);
...
\hfill
\begin{minipage}[c]{.45\linewidth}
Un instant après son départ, l'électron partie de 1 émet un photon. un instant plus tard, l'électron partie de 2 absorbe ce photon.
\end{minipage}
\vspace {.7cm}
...
\begin{minipage}[c]{.45\linewidth}
\begin{tikzpicture}
\begin{scope}[scale=0.7] % DEUX PHOTONS
%Création des axes xy
   \draw[-latex, very thick] (0,0) -- (5,0) node[below] {espace};
   \draw[-latex, very thick] (0,0) -- (0,5) node[left] {temps};
% Définition des noeuds
   \coordinate (e11) at (1,1);   \coordinate (e12) at (1.7,2);
   \coordinate (e13) at (1.8,3.5);   \coordinate (e14) at (1,4.5);

   \coordinate (e21) at (4.2,1);   \coordinate (e22) at (3.4,2.2);
   \coordinate (e23) at (3.4,3.2);   \coordinate (e24) at (4.5,4.5);
% dessin des particules
\draw [electron, very thick] (e11) -- (e12); \draw [electron, very thick] (e12) -- (e13);
\draw [electron, very thick] (e13) -- (e14); \draw [electron, very thick] (e21) -- (e22);
\draw [electron, very thick] (e22) -- (e23); \draw [electron, very thick] (e23) -- (e24);
\draw [photon, very thick] (e12) -- (e22); \draw [photon, very thick] (e13) -- (e23);
% Nommage
  \draw (e11) node [left] {1};  \draw (e14) node [left] {3};
  \draw (e21) node [right] {2};  \draw (e24) node [right] {4};
\end{scope}
\end{tikzpicture}
\begin{center}
{\bf Chemin 3.}
...
%Création des axes xy
   ...
   \draw[-latex, very thick] (0,0) -- (0,5) node[left] {temps};
% Définition des noeuds
   \coordinate (e1) at (1.5,1);   \coordinate (e2) at (3.5,1);
   \coordinate (e3) at (1,4);   \coordinate (e4) at (4,4);
% Définition des noeuds
   \coordinate (e1) at (1.5,1);   \coordinate (e5) at (2,2.4);
   \coordinate (e3) at (1,4);   \coordinate (e6) at (3.4,2.6);
% dessin des particules
\draw [electron, very thick] (e1) -- (e5); \draw [electron, very thick] (e5) -- (e4);
\draw [electron, very thick] (e2) -- (e6); \draw [electron, very thick] (e6) -- (e3);
\draw [photon, very thick] (e6) -- (e5);
% Nommage
  \draw (e1) node [left] {1};  \draw (e2) node [right] {2};
  \draw (e3) node [left] {3};  \draw (e4) node [right] {4};
