...
\section{Visions, interprétations et paradigmes scientifiques}

Quelle {\it vision} les {\it physiciens} ont-ils de la {\it lumière} ? Y-t-il plusieurs {\it vision} de la {\it lumière} ? Peut-on avoir une {\it vision} de la {\it lumière} ?

Le lien intime entre la lumière et la vision impose de préciser la question. Ainsi, en fait de {\it vision}, nous devrions parler selon les cas de {\bf paradigme} ou d'{\bf interprétation}. En fait de {\it physiciens}, nous devrions parler selon les cas de {\bf physique}, d'{\bf opticien} ou de {\bf théoricien}. Enfin, nous verrons qu'en fait de {\it lumière}, nous devrions parler selon les cas de {\bf lumière visible}, d'{\bf onde électromagnétique} ou du {\bf champ Photon}.


La physique dispose de plusieurs paradigmes associés aux phénomènes lumineux. On peut distinguer l'optique géométrique, l'optique ondulatoire, l'optique corpusculaire, la physique quantique.
...
La physique quantique réalise une unification de la lumière et de la matière.

Afin de fabriquer une lunette astronomique ou un téléobjectif, l'opticien va utiliser l'optique géométrique. Afin de concevoir une antenne, l'ingénieur va utiliser l'électromagnétisme (paradigme ondulatoire). Enfin, l'expérience d'Alain Aspect ne met pas en défaut le paradigme de la physique quantique.
