...
%\tikzset{>={Straight Barb[angle'=80, scale=1.1]}, photon/.style={decorate, decoration={snake, segment length=3pt, amplitude=0.8pt}, draw=red}}
\tikzset{photon/.style={decorate, decoration={snake, segment length=3pt, amplitude=0.8pt}, draw=red}}
